...
public class DatabaseChangeLog {
    @ChangeSet(order = "001", id = "dropDb", author = "Shishkin Anton", runAlways = true)
    public void dropDb(MongoDatabase db) {
        db.drop();
    }

    @ChangeSet(order = "002", id = "insertNewGenre", author = "Shishkin Anton")
    ...
    @ChangeSet(order = "003", id = "insertNewGenreAnotherWay", author = "Shishkin Anton")
